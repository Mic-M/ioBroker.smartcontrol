        ...
        try {
            ...
            if (this.triggerIsToggle && onOff == 'off') {
                ...
                if (zoneOffTimeLeft > -1) {
                    this.adapter.log.debug(`Zone '${zoneName}': Turn off 'always off' timer, since still running ${(zoneOffTimeLeft / 1000).toFixed(0)} seconds and toggle trigger triggered to turn off.`);
