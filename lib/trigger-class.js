    ...
    async asyncSetTargetDevices() {
        ...
        try {
            ...
            for (const lpZoneName of this.zoneNames) {
                ...
                const MAX_LENGTH = 100; // TODO: Add to adapter configuration as option
                this.adapter.x.zonesLog = this.adapter.x.zonesLog.slice(0, MAX_LENGTH-1); // just keep first x entries
