...
class Library {
     ...
     * 
     * Exception 1: States under javascript.x/0_userdata.0/alias.x: For states created by users under javascript.x/0_userdata.0, this behavior can be changed in the adapter options.
